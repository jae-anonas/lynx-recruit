    ...
    const mockProjects: Project[] = [
      {
        ...
        description: 'Quantity survey for 12-story office building in Auckland CBD',
        status: 'Completed',
        startDate: '2025-05-01',
        endDate: '2025-06-15',
        budget: 'NZ$425,000',
        location: 'Auckland, New Zealand',
        assignedSurveyor: 'Michael Thompson',
        progress: 100,
      },
      {
        id: '2',
        ...
        assignedSurveyor: 'Emma Johnson',
        progress: 65,
      },
      {
        id: '3',
        title: 'Shopping Centre Extension',
        description: 'Survey for shopping centre expansion and renovation project',
        status: 'Planning',
      ...
      },
      {
        ...
        assignedSurveyor: 'David Mitchell',
        progress: 40,
      },
      {
        id: '5',
